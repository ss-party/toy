...
class PaperWeightActivity : AppCompatActivity() {
    ...
    private fun MutableList<WeightPaperData>.putCard(listInDate: ArrayList<Schedule>, color: String, title: String, main: String, sub: String) {
        ...
        add(WeightPaperData(paper_weight_color_circle = color, paper_weight_item_title = title,
                paper_weight_question_tv = main, paper_weight_sub_tv = sub, isYes = isRecord, paper_weight_comment = comment))
    }
